            ...
            if (!self.state.loading) {
                self.openLoading('<p>Encrypting connection (AES-256)...</p>', function () {
                    self.openLoading('<p>Opening configurations file for <strong>' + self.state.username + '</strong>..</p>', function () {
                        self.openLoading('<p>Getting <strong>' + self.refs.followers.value + '</strong> pictures from <strong>' + self.state.username + '</strong>..</p>', function () {
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                'View private Instagram Profiles - without them knowing!'
                            )
                        )
                    ),
                    _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'h3',
                                                null,
                                                '1. What private Instagram Profile do you want to see?'
                                            ),
                                            _react2.default.createElement(
                                                'div',
                                                { className: 'username-input' },
                                                _react2.default.createElement('input', { type: 'text', id: 'username', ref: 'username', placeholder: 'Enter username...', onChange: this.changeUsername.bind(this) })
                                            ),
                                            _react2.default.createElement(
                                                'div',
                                            ...
                                            _react2.default.createElement(
                                                'p',
                                                null,
                                                'Please make sure that you enter the correct instagram username. We will use this username to search the database to find the account.'
                                            )
                                        )
                                    )
                                ),
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'h3',
                                                null,
                                                '2. Choose amount of photos to see'
                                            ),
                                            _react2.default.createElement(
                                                'div',
                                                { className: 'row' },
                                            ...
                                            _react2.default.createElement(
                                                'p',
                                                null,
                                                'Please choose the amount of private photos you want to see.'
                                            )
                                        )
                                    )
                                )
